 ...
 * this file makes me HAPPY. i haven't coded anything fun in a while
 *
 * download the source as a txt file [rename to .js to use]
 * read /Linkmatrix for how to use this
 *
...
function draw( arg_imgOpts ) {
  ...
  "'" + name + "'" +
  ");\">" + 
  "<img name='" + name + "' " + arg_imgOpts + " src=\"\a.gif\">" +
  "</a>";
}
...
function rollOverLink( arg_linkImgName) {
  if( document.images )
    if( window.document[arg_linkImgName].src ) {
      window.document[arg_linkImgName].src = "aOn.gif";
      } else
...
function rollOffLink( arg_linkImgName ) {
  if( document.images )
    if( window.document[arg_linkImgName].src ) {
      window.document[arg_linkImgName].src = "a.gif";
      } else
        alert( "rollOverLink( arg_linkImgName ) failed" );
}
